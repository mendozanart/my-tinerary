...
const inicio = () => {
        ...
        <div>
          ...
          <div className='header col-12'>
            <div className='textoheader col-4'>
              <h1 className='tituloheader'>PLAN YOUR NEXT VACATIONS</h1>
              <h4 className='subtituloheader'>Get to know people's favorite places around the world</h4>
              <h4 className='subtituloheader'>Plan the best vacations of your life</h4>
              <Linkrouter className='btn btn-warning mt-3' to='/usuarios'>Sign up</Linkrouter>
            </div>
    ...
    <div className="row height d-flex justify-content-center align-items-center">
      ...
      <div id="carouselExampleCaptions" className="carousel slide col-10 mb-2 m-auto" data-bs-ride="carousel">
...
<div className="row row-cols-1 row-cols-md-3 col-8 m-auto mt-4 mb-4 g-4">
  <div className="col">
    <div className="card h-100">
      ...
      <div className="card-body">
        ...
        <p className="subtitulocard card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
      </div>
  ...
  <div className="col">
    <div className="card h-100">
      ...
      <div className="card-body">
        <h4 className="titulocard card-title">Visit the best restaurants</h4>
        <p className="subtitulocard card-text">This card has supporting text below as a natural lead-in to additional content.</p>
      </div>
      <div className="card-footer">
        <small className="text-muted">Last updated 3 mins ago</small>
      </div>
  ...
  <div className="col">
    <div className="card h-100">
      ...
      <div className="card-body">
        ...
        <p className="subtitulocard card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This card has even longer content than the first to show that equal height action.</p>
      </div>
      <div className="card-footer">
        <small className="text-muted">Last updated 3 mins ago</small>
      </div>
